...
export class ApiService{
	...
	/* Methods */
	requestAllStores(){
		return this.http.get('https://private-anon-d77ff3624d-gocco.apiary-mock.com/stores');
	}
	...
	requestProducts(storeId:number, filters){
		const url = 'https://private-anon-d77ff3624d-gocco.apiary-mock.com/stores/' + storeId + '/products/search?filters=&with_text=&category_id=' + filters.categoryId + '&order=' + filters.order + '&dir=' + filters.dir + '&page=' + filters.page + '&limit=' + filters.limit;
		console.log(url);
